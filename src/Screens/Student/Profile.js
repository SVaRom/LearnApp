...
import { HStack,Avatar,Heading,VStack,ScrollView, Divider,ZStack,Pressable,HamburgerIcon,Center,Box,IconButton,Icon, Link,Flex,Menu,Modal,Button,useToast } from "native-base";
const Profile = ({ navigation, data }) => {
  ...
  <Center paddingBottom="2">
      ...
      return <Pressable accessibilityLabel="More options menu" {...triggerProps}>
        ...
        >Cambiar foto de perfil</Menu.Item>
      </Menu>
      </HStack>
  </Center>
